...
@section('title', 'Detalji radne pozicije')
...
@section('content')
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="exampleModalLabel">Brisanje radne pozicije</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					Da li želite obrisati radnu poziciju {{ $position->name }} ?
				</div>
	...
	<div class="modal fade" id="resource-detach-modal" tabindex="-1" role="dialog" aria-labelledby="resource-detach-modal" aria-hidden="true">
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="resource-detach-modal">Brisanje zaposlenika sa radne pozicije</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					Jeste li sigurni da želite obrisati odabranog zaposlenika sa radne pozicije ?
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Zatvori</button>
		...
		<div class="app-header">
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-6 col-sm-12 app-header__add-btn">
					...
					<a class="btn custom-button mr-2" href="{{ route('positions.edit', $position) }}">
		...
		<div class="app-header">
			<div class="row d-flex align-items-center">
				<div class="col-md-12 col-sm-12 app-header__title">
					<h3>Zaposleni na poziciji - {{ $position->name }}</h3>
				</div>
			</div>
		</div>
						...
						<table id="resources" class="table " style="width: 100%">
							...
							<tbody>
								...
								<tr>
					        		...
					        		<td class="text-right">
					        			<button class="action-icon action-icon-danger resource-detach-btn" data-url="{{ route('positions.detach',['position' => $position, 'user' => $user]) }}" data-toggle="modal" data-target="#resource-detach-modal" type="button">
