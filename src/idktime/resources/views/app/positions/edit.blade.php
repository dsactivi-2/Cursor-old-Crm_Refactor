...
@section('title', 'Uredi radnu poziciju')
		...
		<div class="app-content form-content shadow">
			<form method="POST" action="{{ route('positions.update', $position) }}">
				...
				<div class="form-group row">
				    ...
				    <div class="col-md-6">
				        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Ime radne pozicije" value="{{ $position->name }}" required>
				        @error('name')
