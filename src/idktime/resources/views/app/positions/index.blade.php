		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Jeste li sigurni da želite obrisati odabranu radnu poziciju ?
				</div>
		...
		<div class="app-header">
			<div class="row d-flex align-items-center">
				<div class="col-md-6 col-sm-12 app-header__title">
					<h3>Radne pozicije</h3>
				</div>	

				<div class="col-md-6 col-sm-12 app-header__add-btn">
					<a class="btn custom-button" href="{{ route('positions.create') }}">
							...
							<table id="resources" class="table " style="width: 100%">
								<thead>
									<tr>
										...
										<th class="text-center">
											Broj zaposlenih na radnoj poziciji
										</th>
										<th></th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
						        		...
						        		<td class="text-right">
						        			<button class="action-icon action-icon-danger single-resource-delete-btn" data-resource-id="{{ $position->id }}" data-toggle="modal" data-target="#single-resource-delete-modal" type="button">
												<i class="far fa-trash-alt"></i>
											</button>
						        			<a class="action-icon action-icon-primary ml-2 mr-2" href="{{ route('positions.show', $position) }}">
						        				<i class="far fa-eye"></i>
						        			</a>
						        			<a class="action-icon action-icon-primary" href="{{ route('positions.edit', $position) }}">
...
@section('js')
	<script>
		...
		singleResourceDeleteBtn.on('click', function() {
            ...
            var url = '{{ route("positions.destroy", ":resourceID") }}';
