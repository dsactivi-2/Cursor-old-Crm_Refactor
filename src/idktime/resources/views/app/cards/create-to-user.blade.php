...
@section('title', 'Nova RFID kartica za korisnika ' . $user->name)
...
@section('content')
	...
	<div class="container pb-4">
		<div class="app-header">
			<div class="row d-flex align-items-center">
				<div class="col-md-6 col-sm-12 app-header__title">
					<h3>Nova RFID kartica za korisnika - {{ $user->name }}</h3>
				</div>	
		...
		<div class="app-content form-content shadow">
			<form method="POST" action="{{ route('cards.store-to-user', $user) }}">
				...
				<div class="form-group row">
				    ...
				    <div class="col-md-6">
				        <input type="text" class="form-control @error('uuid') is-invalid @enderror" id="uuid" name="uuid" placeholder="Identifikacijski broj kartice" value="{{ old('uuid') }}" autofocus>
				        @error('uuid')
