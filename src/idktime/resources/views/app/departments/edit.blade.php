		...
		<div class="app-content form-content shadow">
			<form method="POST" action="{{ route('departments.update', $department) }}">
				...
				<div class="form-group row">
				    ...
				    <div class="col-md-6">
				        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Ime službe" value="{{ $department->name }}" required>
				        @error('name')
