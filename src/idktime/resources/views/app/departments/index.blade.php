		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Jeste li sigurni da želite obrisati odabranu odjel ?
				</div>
		...
		<div class="app-header">
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-6 col-sm-12 app-header__add-btn">
					<a class="btn custom-button" href="{{ route('departments.create') }}">
						Dodaj Odjel
					</a>
				</div>
			</div>
							...
							<table id="resources" class="table " style="width: 100%">
								...
								<tbody>
									...
									<tr>
						        		...
						        		<td class="text-right">
						        			<button class="action-icon action-icon-danger single-resource-delete-btn" data-resource-id="{{ $department->id }}" data-toggle="modal" data-target="#single-resource-delete-modal" type="button">
												<i class="far fa-trash-alt"></i>
											</button>
						        			<a class="action-icon action-icon-primary ml-2 mr-2" href="{{ route('departments.show', $department) }}">
						        				<i class="far fa-eye"></i>
						        			</a>
						        			<a class="action-icon action-icon-primary" href="{{ route('departments.edit', $department) }}">
...
@section('js')
	<script>
		...
		singleResourceDeleteBtn.on('click', function() {
            ...
            var url = '{{ route("departments.destroy", ":resourceID") }}';
