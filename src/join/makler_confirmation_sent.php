...
$translations = array(
    "ba" => array(
        "header" => "Poštovani,",
        "subheader" => "Provjerite svoj email za potvrdu vašeg računa!",
    ...
    "de" => array(
        ...
        "subheader" => "Vielen Dank für die Registrierung. Bitte überprüfen Sie Ihre E-Mails, um Ihre Registrierung zu bestätigen.",
    ...
    "en" => array(
        "header" => "Dear user,",
        "subheader" => "Check your email for account confirmation. Thank you for registering!",
...
<body>
    <div class="container">
        ...
        <div class="confirmation-message">
            ...
            <p><?php translateTextCon("subheader"); ?></p>
        </div>
    </div>
    <div class="footer">
