...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'hr', targetLanguage: 'de'}, 'google_translate_element');
}
</script>
...
<body>
	<div id="google_translate_element">
		...
		<div class="container idk_cv_container">
		<?php
			switch ($page){
		...
		<form action="<?php getSiteURL(); ?>do.php?form=cv_gen" name="frm-exp" id="frm-exp" method="POST">
			<div class="row">
				<div class="col-sm-12">
				<br/>
					<div class="row">
						<div class="col-xs-3 text-right">
							<b><p class="notranslate">PERSÖNLICHE INFORMATIONEN</p></b>
						</div>
						<div class="col-xs-6 idk_list_style">
							<h2 class="notranslate"><?php echo $kandidat_ime; ?> <?php echo $kandidat_prezime; ?></h2>
							<ul class="fa-ul">
								<li><i class="fa-li fa fa-id-card" aria-hidden="true"></i><p>ID: <?php echo $kandidat_id; ?></p></li>
								<li><i class="fa-li fa fa-map-marker" aria-hidden="true"></i><p class="notranslate"><?php echo $kandidat_adresa; ?>, <?php echo $kandidat_pbroj; ?>, <?php echo $kandidat_grad; ?></p></li>
								<?php
							...
							<ul class="list-inline idk_list_inline">
								<li><span class="notranslate">Geschlecht</span><p><?php echo $kandidat_spol; ?></p></li>
								<li>|</li>
								<li><span class="notranslate">Geburtsdatum</span><p><?php echo $kandidat_datumrodjenja; ?></p></li>
								<li>|</li>
								<li><span class="notranslate">Staatsangehörigkeit</span><p><?php echo $kandidat_drzavljanstvo; ?></p></li>
							</ul>
						</div>
						<div class="col-xs-3">
				...
				$('#prijava_na').editable({
						...
						success: function(response, newValue) {
							$('#prijava_na').addClass("notranslate");
							$("#inp_prijava_na").val(newValue);
						}
					});
				});
				</script>
				...
				<br/>
					<div class="row">
						<div class="col-xs-3 text-right">
							<b><p class="notranslate">ANGESTREBTE STELLE</p></b>
						</div>
						<div class="col-xs-9 idk_list_style">
							<a href="#" id="prijava_na"><?php echo $kandidat_prijava_na; ?></a>
							<input type="hidden" id="inp_prijava_na" name="inp_prijava_na" value="<?php echo $kandidat_prijava_na; ?>"/>
						</div>
					</div>
					<br/>
				</div>
				...
				<div class="col-xs-12">
					<div class="col-xs-3 text-right">
						<b><p class="notranslate">BERUFSERFAHRUNG</p></b>
					</div>
				...
				<div class="col-xs-12">
					...
					<div class="col-xs-9 idk_h3_style">
						...
						<p class="notranslate"><?php echo $kri_naziv; ?></p>
				...
				<div class="col-xs-12">
					<div class="col-xs-3 text-right">
						<b><p class="notranslate">SCHUL-UND BERUFSBILDUNG</p></b>
					</div>
					<div class="col-xs-9 idk_span_underline">
						<span></span>
					</div>
				...
				<div class="col-xs-12">
					...
					<div class="col-xs-9 idk_h3_style">
						...
						<p class="notranslate"><?php echo $ke_naziv; ?></p>
				...
				<div class="col-xs-12">
					<div class="col-xs-3 text-right">
						<b><p class="notranslate">PERSÖNLICHE FÄHIGKEITEN</p></b>
					</div>
					<div class="col-xs-9 idk_span_underline">
						<span></span>
					</div>
				...
				<div class="col-xs-12">
					<div class="col-xs-3 text-right">
						<p class="notranslate">Sprachen</p>
					</div>
					<div class="col-xs-9">
									<table class="table table-hover">
										<thead>
											<tr>
												...
												<th class="text-center notranslate">Sprache</th>
												<th class="text-center notranslate">Hören</th>
												<th class="text-center notranslate">Lesen</th>
												<th class="text-center notranslate">An gesprächen teilnehmen</th>
												<th class="text-center notranslate">Zusammenhängendes sprechen</th>
												<th class="text-center notranslate">Schreiben</th>
											</tr>
										</thead>
										<tbody>
											<?php
				...
				<div class="col-xs-12 idk_margin_top30">
					<div class="row">
						...
						<div class="col-xs-9 idk_table_p">
							<p class="notranslate">Niveaus: A1/2: Anfänger - B1/2: Unabhängiger Benutzer - C1/2 Erfahrener Benutzer</p>
							<a href="http://europass.cedefop.europa.eu/hr/resources/european-language-levels-cefr"><p class="notranslate">Gemeinsamer europäischer Referenzrahmen für Sprachen</p></a>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12">
					<div class="col-xs-3 text-right">
						<b><p class="notranslate">Führerschein B</p></b>
					</div>
					<div class="col-xs-9 idk_h3_style">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10 text-right">
					<button type="submit" class="btn material-btn material-btn-icon-success material-btn_success main-container__column"><i class="fa fa-plus" aria-hidden="true"></i> <span class="notranslate">Generiši PDF</span></button>
				</div>
			</div>
		</form>
		<?php
