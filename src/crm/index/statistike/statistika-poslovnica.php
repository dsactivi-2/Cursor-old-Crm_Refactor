...
*
*
** Last update - Adis Toromanovic - Date: 29.07.2022. DESC: Razdvojen broj predracuna na prihvacene i neprihvacene
*
*/
							...
							<div class="col-md-12 col-xs-12" style = "overflow-y: auto !important;">
									...
									$(document).ready(function() {
										var table = $('#tableStat').DataTable({
											...
											"aoColumns": [
												...
												{ "width": "7.5%", "bSortable": false },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "6.5%", "bSortable": true },
												{ "width": "18.5%", "bSortable": true }
											]
										});
								...
								<table id="tableStat" class="display" cellspacing="0" width="100%">
									...
									<?php 
										...
										$sum_broj_neprihvacenih_CD = 0;
										$sum_broj_neprihvacenih_KS1 = 0;
										$sum_broj_neprihvacenih_KS2 = 0;
										$sum_broj_neprihvacenih_KS3 = 0;
										$sum_broj_neprihvacenih_KS4 = 0;
										$sum_broj_neprihvacenih_PM = 0;
										$sum_broj_neprihvacenih_KS = 0;
										...
										while($row3 = $query3->fetch()){
											...
											$sum_broj_neprihvacenih_CD = $sum_broj_neprihvacenih_CD + $broj_neprihvacenih_CD;
											$sum_broj_neprihvacenih_KS1 = $sum_broj_neprihvacenih_KS1 + $broj_neprihvacenih_KS1;
											$sum_broj_neprihvacenih_KS2 = $sum_broj_neprihvacenih_KS2 + $broj_neprihvacenih_KS2;
											$sum_broj_neprihvacenih_KS3 = $sum_broj_neprihvacenih_KS3 + $broj_neprihvacenih_KS3;
											$sum_broj_neprihvacenih_KS4 = $sum_broj_neprihvacenih_KS4 + $broj_neprihvacenih_KS4;
											$sum_broj_neprihvacenih_PM = $sum_broj_neprihvacenih_PM + $broj_neprihvacenih_PM;
											$sum_broj_neprihvacenih_KS = $sum_broj_neprihvacenih_KS + $ukupno_broj_neprihvacenih_KS;
									...
									?>
										...
										?>
											<td class="text-center" style = "border-left: 1px solid #111111;" ><a class="a_link" target="_blank" <?php if($broj_izdanih_CD != 0 OR $broj_neprihvacenih_CD != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed=0&id_men='. invertSign(1) .'&year='.$year1.'"'; ?>><?php echo getStyleColumn1($broj_neprihvacenih_CD, $broj_izdanih_CD, $broj_uplacenih_CD, $uplacenih_CD); ?></a></td>
											<td class="text-center"><a class="a_link" target="_blank" <?php if($broj_izdanih_KS1 != 0 OR $broj_neprihvacenih_KS1 != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed='.$week1.'&id_men='. invertSign(2) .'&year='.$year1.'"'; ?>><?php echo getStyleColumn1($broj_neprihvacenih_KS1, $broj_izdanih_KS1, $broj_uplacenih_KS1, $uplacenih_KS1); ?></a></td>
											<td class="text-center"><a class="a_link" target="_blank" <?php if($broj_izdanih_KS2 != 0 OR $broj_neprihvacenih_KS2 != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed='.$week2.'&id_men='. invertSign(3) .'&year='.$year2.'"'; ?>><?php echo getStyleColumn1($broj_neprihvacenih_KS2, $broj_izdanih_KS2, $broj_uplacenih_KS2, $uplacenih_KS2); ?></a></td>
											<td class="text-center"><a class="a_link" target="_blank" <?php if($broj_izdanih_KS3 != 0 OR $broj_neprihvacenih_KS3 != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed='.$week3.'&id_men='. invertSign(4) .'&year='.$year3.'"'; ?>><?php echo getStyleColumn1($broj_neprihvacenih_KS3, $broj_izdanih_KS3, $broj_uplacenih_KS3, $uplacenih_KS3); ?></a></td>
											<td class="text-center"><a class="a_link" target="_blank" <?php if($broj_izdanih_KS4 != 0 OR $broj_neprihvacenih_KS4 != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed='.$week4.'&id_men='. invertSign(6) .'&year='.$year4.'"'; ?>><?php echo getStyleColumn1($broj_neprihvacenih_KS4, $broj_izdanih_KS4, $broj_uplacenih_KS4, $uplacenih_KS4); ?></a></td>
											<td class="text-center"><?php echo getStyleColumn1($broj_neprihvacenih_PM, $broj_izdanih_PM, $broj_uplacenih_PM, $uplacenih_PM); ?></td>
											<td class="text-center"><a class="a_link" target="_blank" <?php if($ukupno_broj_izdanih_KS != 0 OR $ukupno_broj_neprihvacenih_KS != 0) echo 'href = "statistike.php?page=predracuni&branch_id='.intval($row3["branch_id"]).'&sed=-1&id_men='. invertSign(6) .'&year='.$year5.'"'; ?>><?php echo getStyleColumn1($ukupno_broj_neprihvacenih_KS, $ukupno_broj_izdanih_KS, $ukupno_broj_uplacenih_PM, $ukupno_uplacenih_PM); ?></a></td>
										<?php
											}else{
										?>
											<td class="text-center" style = "border-left: 1px solid #111111;"><?php echo getStyleColumn1($broj_neprihvacenih_CD, $broj_izdanih_CD, $broj_uplacenih_CD, $uplacenih_CD); ?></td>
											...
											<td class="text-center"><?php echo getStyleColumn1($broj_neprihvacenih_PM, $broj_izdanih_PM, $broj_uplacenih_PM, $uplacenih_PM); ?></td>
											<td class="text-center"><?php echo getStyleColumn1($ukupno_broj_neprihvacenih_KS, $ukupno_broj_izdanih_KS, $ukupno_broj_uplacenih_PM, $ukupno_uplacenih_PM); ?></td>
										<?php
											}
										?>
										</tr>
									...
									<tfoot>
										...
										<?php
											if (in_array(("9"), $employee_status) || in_array(("1"), $employee_status)){
										?>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_CD != 0 OR $sum_broj_neprihvacenih_CD != 0) echo 'href = "statistike.php?page=predracuni&sed=0&id_men='. invertSign(1) .'&year='.$year1.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_CD, $sum_broj_izdanih_CD, $sum_broj_uplacenih_CD, $sum_uplacenih_CD); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_KS1 != 0 OR $sum_broj_neprihvacenih_KS1 != 0) echo 'href = "statistike.php?page=predracuni&sed='.$week1.'&id_men='. invertSign(2) .'&year='.$year1.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS1, $sum_broj_izdanih_KS1, $sum_broj_uplacenih_KS1, $sum_uplacenih_KS1); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_KS2 != 0 OR $sum_broj_neprihvacenih_KS2 != 0) echo 'href = "statistike.php?page=predracuni&sed='.$week2.'&id_men='. invertSign(3) .'&year='.$year2.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS2, $sum_broj_izdanih_KS2, $sum_broj_uplacenih_KS2, $sum_uplacenih_KS2); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_KS3 != 0 OR $sum_broj_neprihvacenih_KS3 != 0) echo 'href = "statistike.php?page=predracuni&sed='.$week3.'&id_men='. invertSign(4) .'&year='.$year3.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS3, $sum_broj_izdanih_KS3, $sum_broj_uplacenih_KS3, $sum_uplacenih_KS3); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_KS4 != 0 OR $sum_broj_neprihvacenih_KS4 != 0) echo 'href = "statistike.php?page=predracuni&sed='.$week4.'&id_men='. invertSign(6) .'&year='.$year4.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS4, $sum_broj_izdanih_KS4, $sum_broj_uplacenih_KS4, $sum_uplacenih_KS4); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_PM, $sum_broj_izdanih_PM, $sum_broj_uplacenih_PM, $sum_uplacenih_PM); ?></a></th>
											<th class="text-center" style ="font-weight: bold;"><a class="a_link" target="_blank" <?php if($sum_broj_izdanih_KS != 0 OR $sum_broj_neprihvacenih_KS != 0) echo 'href = "statistike.php?page=predracuni&sed=-1&id_men='. invertSign(6) .'&year='.$year5.'"'; ?>><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS, $sum_broj_izdanih_KS, $sum_broj_uplacenih_KS, $sum_uplacenih_KS); ?></a></th>
										<?php 
											}else{
										?>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_CD, $sum_broj_izdanih_CD, $sum_broj_uplacenih_CD, $sum_uplacenih_CD); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS1, $sum_broj_izdanih_KS1, $sum_broj_uplacenih_KS1, $sum_uplacenih_KS1); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS2, $sum_broj_izdanih_KS2, $sum_broj_uplacenih_KS2, $sum_uplacenih_KS2); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS3, $sum_broj_izdanih_KS3, $sum_broj_uplacenih_KS3, $sum_uplacenih_KS3); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS4, $sum_broj_izdanih_KS4, $sum_broj_uplacenih_KS4, $sum_uplacenih_KS4); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_PM, $sum_broj_izdanih_PM, $sum_broj_uplacenih_PM, $sum_uplacenih_PM); ?></th>
											<th class="text-center" style ="font-weight: bold;"><?php echo getStyleColumn1($sum_broj_neprihvacenih_KS, $sum_broj_izdanih_KS, $sum_broj_uplacenih_KS, $sum_uplacenih_KS); ?></th>
