...
<body>
	...
	<div id="content">
			...
			$('.reorder_link').on('click',function(){
				...
				$("#save_reorder").click(function( e ){
					if( !$("#save_reorder i").length ){
						...
						$.ajax({
							type: "POST",
							url: "<?php getSiteURL(); ?>orderUpdatesss.php",
		...
		<?php
				...
				case "add":
					if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){
						
					if(isset($_GET['id'])){
						$project_nalogid = $_GET['id'];
					}else{
						$project_nalogid = 0;
					}	
		?>
						...
						<div class="row">
							<div class="col-md-offset-1 col-md-8">
								<form id="idk_form" action="<?php getSiteURL(); ?>do_modules.php?form=add_project" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
									<input type="hidden" name="project_nalogid" value="<?php echo $project_nalogid; ?>">
									...
									<div class="form-group">
										<label for="project_datumtermina" class="col-sm-3 control-label">Termin za vizu od:</label>
										<div class="col-sm-9">
											<div class="materail-input-block materail-input-block_success">
												<input class="form-control materail-input" type="text" autocomplete="off" name="project_datumtermina" id="project_datumtermina" class="monthPicker" placeholder="Termin za vizu od">
												<span class="materail-input-block__line"></span>
											</div>
										</div>
										<style>
										...
										$(document).ready(function(){
											$("#project_datumtermina").datepicker({
												dateFormat: 'mm.yy',
												changeMonth: true,
												changeYear: true,
												closeText : "Potvrdi",
									...
									<div class="form-group">
										<label for="project_datumterminado" class="col-sm-3 control-label">Termin za vizu do:</label>
										<div class="col-sm-9">
											<div class="materail-input-block materail-input-block_success">
												<input class="form-control materail-input" type="text" autocomplete="off" name="project_datumterminado" id="project_datumterminado" class="monthPicker" placeholder="Termin za vizu do">
												<span class="materail-input-block__line"></span>
											</div>
										</div>
										<style>
										...
										$('.ui-datepicker-calendar').hide();
										$(document).ready(function(){
											$("#project_datumterminado").datepicker({
												dateFormat: 'mm.yy',
												changeMonth: true,
												changeYear: true,
												closeText : "Potvrdi",
		...
		<?php
				...
				case "edit":
					if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){
						...
						$query = $db->prepare("
										SELECT project_name, project_desc, project_plannedhours, project_companyid, project_pmanagerid, project_datumtermina, project_datumterminado
										FROM idk_projects
						...
						$row = $query->fetch();
							...
							if($row['project_datumtermina'] != NULL){
								$project_datumtermina = date('d.m.Y', strtotime($row['project_datumtermina']));
							}else{
								$project_datumtermina = NULL;
							}
							if($row['project_datumterminado'] != NULL){
								$project_datumterminado = date('d.m.Y', strtotime($row['project_datumterminado']));
							}else{
								$project_datumterminado = NULL;
							}
							...
							<div class="col-md-offset-1 col-md-8">
								<form id="idk_form" action="<?php getSiteURL(); ?>do_modules.php?form=edit_project" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="materail-input-block materail-input-block_success">
												<input class="form-control materail-input" type="text" autocomplete="off" name="project_datumtermina" id="project_datumtermina" value="<?php echo $project_datumtermina; ?>" class="monthPicker" placeholder="Termin za vizu od">
												<span class="materail-input-block__line"></span>
											</div>
										</div>
										<style>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="materail-input-block materail-input-block_success">
												<input class="form-control materail-input" type="text" autocomplete="off" name="project_datumterminado" id="project_datumterminado" value="<?php echo $project_datumterminado; ?>" class="monthPicker" placeholder="Termin za vizu do">
												<span class="materail-input-block__line"></span>
											</div>
										</div>
										<style>
		...
		<?php
				...
				case "open":
					...
					$query = $db->prepare("
									SELECT project_name, project_datetime, employee_firstname, employee_lastname, project_nalogid
									FROM idk_projects
					...
					$query_pp = $db->prepare("SELECT pristup_poslodavcima FROM idk_nalozi WHERE nalog_id = $project_nalogid");
					$query_pp->execute();
					$row_qpp = $query_pp->fetch();
					$nalog_pristup = $row_qpp['pristup_poslodavcima'];
					if($nalog_pristup == 1){
						if(strpos($project_name, ' - Casting')){
							$casting_za_pp = true;
							$intervju_list = false;
							$odbijeni_list = false;
							$thead1 = "Iskustvo";
							$thead2 = "Skola";
							$thead3 = "Termin";
							$thead4 = "Potvrda dolaska";
							$thead5 = "Go Online";
							$thead6 = "Njemacki";
						}elseif(strpos($project_name, ' - Intervju')){
							$casting_za_pp = false;
							$intervju_list = true;
							$thead1 = "CV";
							$thead2 = "Grad";
							...
							$thead4 = "Termin";
							$thead5 = "Njemacki";
							$thead6 = "Status dolaska";
						}elseif(strpos($project_name, ' - Odbijen')){
							$casting_za_pp = false;
							$intervju_list = false;
							$odbijeni_list = true;
							$thead1 = "CV";
						...
						if(in_array($project_name, array('219/2022 - Casting','217/2022 - Casting'))){
						//if(in_array($project_name, array('217/2022 - Casting','219/2022 - Casting','103/2019 - Casting'))){
							$casting_za_pp = true;
							$intervju_list = false;
							$odbijeni_list = false;
							$thead1 = "Iskustvo";
							...
							$thead3 = "Termin";
							$thead4 = "Go Online";
							$thead5 = "Potvrda dolaska";
							$thead6 = "Njemacki";
						}elseif(in_array($project_name, array('222/2022 - Intervju'))){
							$casting_za_pp = false;
							$intervju_list = true;
							$thead1 = "CV";
							$thead2 = "Grad";
							...
							$thead5 = "Njemacki";
							$thead6 = "Status dolaska";
						}elseif(in_array($project_name, array('222/2022 - Odbijen'))){
							$casting_za_pp = false;
							$intervju_list = false;
							$odbijeni_list = true;
							$thead1 = "CV";
						...
						<div class="content_box">
								...
								<div class="col-xs-12">
									<?php
										...
										<?php
											...
											<div class="alert material-alert material-alert_success">Uspješno ste povezali projekat sa nalogom.</div>
											<script>$(function() { $('[href="#projects"]').tab('show'); });</script>
										<?php
										}elseif($mess == 11){ ?>
											<div class="alert material-alert material-alert_success">Uspješno ste dodali kandidate u projekat.</div>
											<script>$(function() { $('[href="#kandidati"]').tab('show'); });</script>
										<?php
										}
									?>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-2">
									...
									<a href="#" class="btn material-btn material-btn-icon-success material-btn_success main-container__column" data-toggle="modal" data-target="#nalogConnModal"><i class="fa fa-check-square" aria-hidden="true"></i> <span>Poveži nalog   </span></a>
									...
									<div class="modal material-modal material-modal_primary fade text-left" id="nalogConnModal">
										<div class="modal-dialog modal-lg">
											<div class="modal-content material-modal__content">
												<div class="modal-header material-modal__header">
													<button class="close material-modal__close" data-dismiss="modal">&times;</button>
													<h4 class="modal-title material-modal__title">Odaberite nalog</h4>
												</div>
												<div class="modal-body material-modal__body">
													<form action="<?php getSiteURL(); ?>do_modules.php?form=add_project_nalog" method="post" role="form" class="form-horizontal">
													<input type="hidden" name="pt_projectid" value="<?php echo $project_id; ?>" />
													<div class="form-group">
														<div class="col-md-offset-1 col-sm-10">
															<select class="selectpicker" id="nalog_id" name="nalog_id" data-live-search="true" required>
																<option value="0"> -- Odaberite nalog --</option>
																<?php
																	$select_query = $db->prepare("
																						SELECT nalog_id, kompanija_id, nalog_naziv, nalog_status, comp.company_name
																						FROM idk_nalozi
																	...
																	$select_query->execute(array(
																					':nalog_status' => 8));
																	while($select_row = $select_query->fetch()) {
																		echo "<option data-subtext='".$select_row['company_name']."' value='" . $select_row['nalog_id'] . "'>" . $select_row['nalog_naziv'] . "</option>";
																	}
																?>
															</select>
															<span class="materail-input-block__line"></span>
												...
												<div class="modal-footer material-modal__footer">
													<ul class="list-inline">
														<li class="hidden"><i class="fa fa-circle-o-notch fa-spin fa-lg fa-fw text-success"></i></li>
														<li><button type="submit" class="btn btn-primary material-btn material-btn_primary">Poveži</button></li>
													</ul>
													</form>
												</div>
											</div>
							...
							<div id="myTabs" class="panel-group material-tabs-group">
								<ul class="nav nav-tabs material-tabs material-tabs_primary">
									<li class="<?php if($tab=="progres"){echo "active";} ?>"><a href="#progres" class="material-tabs__tab-link" data-toggle="tab">Projekt</a></li>
									<li class="<?php if($tab=="kandidati"){echo "active";} ?>"><a href="#kandidati" class="material-tabs__tab-link" data-toggle="tab">Kandidati</a></li>
								...
								<div class="tab-content materail-tabs-content">
									<div class="tab-pane fade <?php if($tab=="progres"){echo "active in";} ?>" id="progres">
										<div class="row">
											<div class="col-md-12">
												<div class="content_box">
													<div class="row">
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-sm-2 text-right">
																<a href="#" data="<?php getSiteURL(); ?>projects?page=del_note&id=<?php echo $note_id; ?>" data-toggle="modal" data-target="#deleteNoteModal" class="delete_note btn material-btn material-btn_danger main-container__column"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
																<script>
										...
										<table id="idk_table_documents" class="display" cellspacing="0" width="100%">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center"><a href="#" data="<?php getSiteURL(); ?>projects?page=del_doc&id=<?php echo $document_id; ?>" data-toggle="modal" data-target="#deleteDocModal" class="delete_doc btn material-btn material-btn_danger main-container__column"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a></td>
												</tr>
												<?php } ?>
												<script>
									...
									<div class="tab-pane fade <?php if($tab=="kandidati"){echo "active in";} ?>" id="kandidati">
										...
										<?php
											...
											if(isset($_GET['search'])){
												...
												if(isset($_GET["iskustvo_u_struci"])){
													if(in_array('Nema', $_GET["iskustvo_u_struci"])){
														//filter array without 'Nema'
														$iskustvo_u_struci = array_filter($_GET["iskustvo_u_struci"], function($value){
															return $value != 'Nema';
														});

														$iskustvo_u_struciImp = implode(',', $iskustvo_u_struci);
														if($iskustvo_u_struciImp == ""){
															$iskustvo_u_struci_uslov = " AND kandidat_iskustvo_u_struci IS NULL";
														}else{
															$iskustvo_u_struci_uslov = " AND (kandidat_iskustvo_u_struci IS NULL OR kandidat_iskustvo_u_struci IN ($iskustvo_u_struciImp))";
														}
													}
													else {
														$iskustvoImp = implode(',', $_GET["iskustvo_u_struci"]);
														$iskustvo_u_struci_uslov = " AND kandidat_iskustvo_u_struci IN ($iskustvoImp)";
													}
												}
												...
												if(isset($_GET['filter_struke_sa_prijave'])){
													$filter_struke_sa_prijave = $_GET['filter_struke_sa_prijave'];
													$filter_struke_sa_prijave_f = implode(',', $filter_struke_sa_prijave);
													
													$uslov_struke_sa_prijave = "AND struka_sa_prijave IN(".$filter_struke_sa_prijave_f.")";
												}else{
													$uslov_struke_sa_prijave = '';
												}
												
												if(isset($_GET['filter_struke_sa_skolom'])){
													$filter_struke_sa_skolom = $_GET['filter_struke_sa_skolom'];
													$filter_struke_sa_skolomImp = implode(",", $filter_struke_sa_skolom);
													
													$query_smjer_struke = $db->prepare("
																				SELECT 
																					ss_naziv
																				FROM 
																					idk_skole_smjerovi
																				WHERE
																					ss_struka_id IN (".$filter_struke_sa_skolomImp.")
													");
													$query_smjer_struke->execute();
													$smjer_naziv = array();
													while($row_smjer_struke = $query_smjer_struke->fetch()){
														$naziv_smjera = $row_smjer_struke['ss_naziv'];
														$smjer_naziv[] = "'".$naziv_smjera."'";
													}
													$smjer_nazivImp = implode(",", $smjer_naziv);
													$uslov_struke_sa_skolom = "AND kandidat_id IN (SELECT ke_kandidat_id FROM idk_kandidat_edukacija WHERE ke_naziv_kvalifikacije IN (".$smjer_nazivImp."))";
												} else {
													$uslov_struke_sa_skolom = '';
												}
												...
												if($vozacka_dozvola == "Da"){
													...
													$uslov_pretrage_vozacka = ''.$and.' (kandidat_vozacka_dozvola = "Da" OR kandidat_vozacka_dozvola = "Ne" OR kandidat_vozacka_dozvola is null)';
												}

												if($termin_za_vizu == "Da"){
													$uslov_pretrage_viza = ''.$and.' datum_termina != NULL';
												}else{
													$uslov_pretrage_viza = ''.$and.' (kandidat_vozacka_dozvola = "Da" OR kandidat_vozacka_dozvola = "Ne" OR kandidat_vozacka_dozvola is null)';
												}

												if($_GET['filter_termin'] == "0"){
													$uslov_pretrage_viza = "";
												}elseif($_GET['filter_termin'] == "1"){
													$uslov_pretrage_viza = ''.$and.' datum_termina != NULL';
												}elseif($_GET['filter_termin'] == "2"){
													$uslov_pretrage_viza = ''.$and.' datum_termina = NULL';
												}
											...
											$uslov_glavni = "".$upit." ".$uslov_saradnik." ".$uslov_pretrage_vozacka." ".$uslov_pretrage_godine."  ".$uslov_pretrage_statusi." ".$uslov_struke_sa_prijave." ".$uslov_pretrage_status." ".$uslov_pretrage_drzavljanstvo." ".$uslov_pretrage_viza." ".$uslov_struke_sa_skolom." " . $iskustvo_u_struci_uslov . "";
											...
											<div class="modal-dialog">
												<div class="modal-content material-modal__content">
													...
													<div class="modal-body material-modal__body">
														...
														<div class="form-group">
															...
															<div class="col-sm-8">
																<div class="row">
																	<div class="col-sm-4">
																		<div class="materail-input-block materail-input-block_success">
																			<input class="form-control materail-input" type="number" name="starost_od" id="starost_od" placeholder="od" value=" ">
																			<span class="materail-input-block__line"></span>
																		</div>
																	</div>
																	<div class="col-sm-4">
																		<div class="materail-input-block materail-input-block_success">
																			<input class="form-control materail-input" type="number" name="starost_do" id="starost_do" placeholder="do" value=" ">
																			<span class="materail-input-block__line"></span>
																		</div>
																	</div>
																</div>
														...
														<div class="form-group">
															<label for="kki_naziv_web" class="col-sm-4 control-label">Iskustvo u struci:</label>
															<div class="col-sm-5">
																<select class="selectpicker" id="iskustvo_u_struci" name="iskustvo_u_struci[]" multiple>
																	<option value=1>Ima iskustvo u struci</option>
																	<option value=0>Nema iskustvo u struci</option>
																	<option value="Nema">Nema informacije</option>
																</select>
															</div>
														</div>
														<div class="form-group">
															<label for="kki_naziv_web" class="col-sm-4 control-label">Minimalno poznavanje njemačkog:</label>
															<div class="col-sm-5">
																<select class="selectpicker" id="kj_znanje_njemacki" name="kj_znanje_njemacki" >
																	<option value="Svi" selected>Svi</option>
																	<option value="Bezznanja">Bez znanja</option>
														...
														<div class="form-group">
															...
															<div class="col-sm-5">
																<select class="selectpicker" id="filter_grupe" name="filter_grupe[]" multiple data-actions-box="true">
																	<?php getGroupList(); ?>
																</select>
															</div>
														</div>
														...
														<div class="form-group">
															<label for="filter_drzavljanstvo" class="col-sm-4 control-label">Termin za vizu:</label>
															<div class="col-sm-5">
																<select class="selectpicker" id="filter_termin" name="filter_termin">
														...
														<div class="form-group">
															<label for="filter_struke_sa_prijave" class="col-sm-4 control-label">Struka (*sa prijave*):</label>
															<div class="col-sm-5">
																<select class="selectpicker" id="filter_struke_sa_prijave" name="filter_struke_sa_prijave[]" multiple>
																	<option value="1">Automehaničar</option>
																	<option value="2">Servisni tehničar</option>
																</select>
															</div>
														</div>
														<div class="form-group">
															<label for="filter_struke_sa_skolom" class="col-sm-4 control-label">Struka (*sa skolom*):</label>
															<div class="col-sm-5">
																<select class="selectpicker" id="filter_struke_sa_skolom" name="filter_struke_sa_skolom[]" multiple>
																	<?php
																		$sql = "SELECT id_struke, naziv_struke FROM idk_struke";
																		$stmt = $db->prepare($sql);
																		$stmt->execute();
																		while($result = $stmt->fetch())
																		{ ?>
																		<option value="<?php echo $result["id_struke"]; ?>"><?php echo $result["naziv_struke"];?></option>
																	<?php }
																	?>
																</select>
															</div>
											...
											<div class="col-md-12">
												<div class="content_box">
													<div class="row">
														...
														<a href="#" class="btn btn-primary material-btn material-btn_success" data-toggle="modal" data-target="#cvModalExport"><i class="fa fa-file-o" aria-hidden="true"></i> CV Export</a>
														<a href="#" id="obicni_export" class="btn btn-primary material-btn material-btn_success"><i class="fa fa-file-o" aria-hidden="true"></i> Obični Export</a>
															<!-- Modal CV -->
																...
																<div class="modal-dialog">
																	<div class="modal-content material-modal__content">
																		...
																		<div class="modal-body material-modal__body text-center">
																			<a id="cvBa" target="_BLANK" href="#"><button class="btn btn-primary material-btn material-btn_success"><img src="<?php getSiteUrl(); ?>images/BosniaHerzegowina.png" width="50">&nbsp &nbsp BOSANSKI</button></a>
																			<a id="cvDe" target="_BLANK" href="#"><button class="btn btn-primary material-btn material-btn_success"><img src="<?php getSiteUrl(); ?>images/Germany.png" width="50">&nbsp &nbsp NJEMAČKI</button></a>
																		</div>
																		<div class="modal-footer material-modal__footer">
																			<button class="btn material-btn material-btn" data-dismiss="modal">Zatvori</button>
																		</div>
															...
															<!-- Modal CV EXPORT -->
															<div class="modal material-modal material-modal_success fade" id="cvModalExport">
																<div class="modal-dialog">
																	<div class="modal-content material-modal__content">
																		<div class="modal-header material-modal__header">
																			<button class="close material-modal__close" data-dismiss="modal">&times;</button>
																		...
																		<div class="modal-body material-modal__body text-center">
																			<a id="cvExpBa" target="_BLANK" href="#"><button class="btn btn-primary material-btn material-btn_success"><img src="<?php getSiteUrl(); ?>images/BosniaHerzegowina.png" width="50">&nbsp &nbsp BOSANSKI</button></a>
																			<a id="cvExpDe" target="_BLANK" href="#"><button class="btn btn-primary material-btn material-btn_success"><img src="<?php getSiteUrl(); ?>images/Germany.png" width="50">&nbsp &nbsp NJEMAČKI</button></a>
																		</div>
																		<div class="modal-footer material-modal__footer">
																			<button class="btn material-btn material-btn" data-dismiss="modal">Zatvori</button>
																		</div>
															...
															<script type="text/javascript">
															$(document).ready(function() {
															$( "#cvExpBa" ).click(function() {
																var jezik = $("#lang").val('ba');
																$("#frm-exp").submit();
															});
															
															$( "#cvExpDe" ).click(function() {
																$("#lang").val('de');
																$( "#frm-exp" ).submit();
															});
																...
																$(".cvshow").click(function () {
																	...
																	document.getElementById("cvBa").href = addressValueBs;
																
																	var addressValueDe = $(this).data("id");
																	document.getElementById("cvDe").href = addressValueDe;
																});
														...
														<div class="col-xs-6 text-right">
															...
															<?php if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){ ?>
													...
													<div id="candidate_ids" style="display: none;">
													...
													<script type="text/javascript">
														$(document).ready(function() {
															...
															$('#obicni_export').on('click', function(e){
																...
																//$('#exportajax').load('<?php getSiteUrl(); ?>export_excel.php?prozor=export_kandidata_u_projektu&selectedis='+selectedIds+'');

																$('#exportajax').load('<?php getSiteUrl(); ?>export_excel.php?prozor=export_kandidata_u_projektu', {
													...
													<form action="<?php getSiteURL(); ?>do_modules.php?form=cv_exp" name="frm-exp" id="frm-exp" method="POST">
														...
														<table id="idk_table_kandidati" class="display" cellspacing="0" width="100%">
																	<thead>
																		<tr>
																			...
																			<th></th>
																			<th>Ime i prezime</th>
																			<th class="text-center"><?php echo $thead1; ?></th>
																			<th class="text-center"><?php echo $thead2; ?></th>
																			<th class="text-center"><?php echo $thead3; ?></th>
																			<th class="text-center"><?php echo $thead4; ?></th>
																			<th class="text-center"><?php echo $thead5; ?></th>
																			<th class="text-center"><?php echo $thead6; ?></th>
																			<th></th>
																		</tr>
																	</thead>
															<tbody>
																<?php
																	// $casting_za_pp
																	$sql = "SELECT kandidat_id, kandidat_ime, kandidat_prezime, kandidat_spol, kandidat_jmbg, kandidat_status, kandidat_slika, kandidat_email, kandidat_datetime, kandidat_visitedurl, kandidat_prijava_na, kandidat_group, cv_ba, cv_de, kandidat_pp_razlog_odbijanja, kandidat_status_prijave, tsr_status
																									FROM idk_kandidati
																									INNER JOIN idk_project_kandidati ON idk_kandidati.kandidat_id = idk_project_kandidati.pk_kandidatid
																									LEFT JOIN idk_pp_cand_appts pca ON kandidat_id = pca.pca_kandidat_id AND pca.pca_status = 1
																									LEFT JOIN idk_pp_appointments app ON pca.pca_appointment_id = app.pap_id
																									LEFT JOIN idk_tf_stats_reservations ON kandidat_id = tsr_candidate_id AND tsr_nalog_id = $project_nalogid AND tsr_interview_id = app.pap_group_id
																									WHERE pk_projectid = :pk_projectid $uslov_glavni GROUP BY pk_kandidatid";
																	...
																	while($row_get_kandidati = $query_get_kandidati->fetch()){
																		...
																		$kandidat_status_prijave = $row_get_kandidati['kandidat_status_prijave'];
																		$kandidat_pp_razlog_odbijanja = $row_get_kandidati['kandidat_pp_razlog_odbijanja'];
																		$tsr_status = $row_get_kandidati['tsr_status'];
																		$cv_ba = $row_get_kandidati['cv_ba'];
																		$cv_de = $row_get_kandidati['cv_de'];
																		$getSiteUrl = getSiteURLr();

																		if($cv_ba == 0){
																			$cv_filepath = 'cv_ba?page=open&id='.$kandidat_id;
																			$cv_flag_ba = 'images/BosniaHerzegowinaDesaturated.png';
																		}else{
																			$cv_filepath = 'files/cv/ba/'.$kandidat_id.'-'.$kandidat_ime.'_'.$kandidat_prezime.'.pdf';
																			$cv_flag_ba = 'images/BosniaHerzegowina.png';
																			
																		}
																	
																		if($cv_de == 0){
																			$cv_filepath_de = 'cv_de?page=open&id='.$kandidat_id;
																			$cv_flag_de = 'images/GermanyDesaturated.png';
																		}else{
																			$cv_filepath_de = 'files/cv/de/'.$kandidat_id.'-'.$kandidat_ime.'_'.$kandidat_prezime.'.pdf';
																			$cv_flag_de = 'images/Germany.png';
																		}


																		// PROVJERA DA LI RADNIK IMA RADNO ISKUSTVO
																		$check_work_experience = $db->prepare("
																							SELECT kri_id, kri_prikaz_pp
																							FROM idk_kandidat_radno_iskustvo
																							WHERE kri_kandidat_id = :kri_kandidat_id ORDER BY kri_prikaz_pp DESC");
																		...
																		$get_njemacki = $db->prepare("SELECT kj_slusanje FROM idk_kandidat_jezici
																									WHERE kj_kandidatid = :kj_kandidatid AND kj_naziv = :kj_naziv");
																		$get_njemacki->execute(array(
																						':kj_kandidatid' => $kandidat_id,
																						':kj_naziv' => "Njemački"
																						));
																		$get_njemacki_row = $get_njemacki->fetch();
																		$njemacki = $get_njemacki_row['kj_slusanje'];
																		if($njemacki == "")
																		...
																		}elseif($row_get_kandidati['kandidat_status'] == 4){
																		...
																		}elseif($row_get_kandidati['kandidat_status'] == 5){
																		...
																		}elseif($row_get_kandidati['kandidat_status'] == 6){
																		...
																		}elseif($row_get_kandidati['kandidat_status'] == 7){
																		...
																		}elseif($row_get_kandidati['kandidat_status'] == 8){
																		...
																		if($casting_za_pp){
																			...
																			if($project_nalogid == 217 OR $project_nalogid == 218 OR $project_nalogid == 219 OR $project_nalogid == 220){
																				$nalog_intervju = 222;
																			}else{
																				$nalog_intervju = $project_nalogid;
																			}
																			$go_online_checker = 0;
																			//PROVJERA DA LI POSTOJI TERMIN
																			$check_termin = $db->prepare("
																							SELECT pap_date, pap_city, pca_time, pca_id 
																							FROM idk_pp_cand_appts 
																							JOIN idk_pp_appointments ON pca_appointment_id = pap_id 
																							WHERE pca_kandidat_id = :pca_kandidat_id AND pap_nalog_id = :pap_nalog_id and pca_status = 1
																			");
																			$check_termin->execute(array(
																							':pca_kandidat_id' => $kandidat_id,
																							':pap_nalog_id' => $nalog_intervju
																			));
																			
																			if($check_termin->rowCount() > 0){
																				$row_termin = $check_termin->fetch();
																				$pca_time = $row_termin['pca_time'];
																				$pap_date = $row_termin['pap_date'];
																				$pap_city = $row_termin['pap_city'];
																				$pca_id = $row_termin['pca_id'];
																				$asdfasasdf = $pap_city.' '.date('d.m.y H:i', strtotime($pap_date.' '.$pca_time));
																				$casting_column3 = '<span class="label label-success material-label material-label_success material-label_xs main-container__column">'.$asdfasasdf.'</span>';
																				$sorting_column3 = ' data-order="'.date('y.m.d H:i', strtotime($pap_date.' '.$pca_time)).'" ';
																				$go_online_checker++;

																				[$confirmation_link_name1, $confirmation_color1, $confirmation_link_name2, $confirmation_color2] = getCastingConfirmationOutput($kandidat_id, $pca_id);

																				$casting_column4 = '
																					<span class= "label label-'.$confirmation_color1.' material-label material-label_'.$confirmation_color1.' material-label_xs main-container__column" style="width: 100%">'.$confirmation_link_name1.'</span>
																					<span class= "label label-'.$confirmation_color2.' material-label material-label_'.$confirmation_color2.' material-label_xs main-container__column" style="width: 100%">'.$confirmation_link_name2.'</span>
																				';
																				$sorting_column4 = 'style="padding-left:0; padding-right:0"';
																			...
																			//PROVJERA DA LI JE CHEKIRANA SKOLA
																			$check_skola = $db->prepare("
																							SELECT count(ke_id) as broj FROM idk_kandidat_edukacija 
																							WHERE ke_kandidat_id = :ke_kandidat_id AND ke_prikaz_pp = 1
																			");
																			$check_skola->execute(array(
																							":ke_kandidat_id" => $kandidat_id
																			));
																			$row_skola = $check_skola->fetch();
																			$nr_skola = $row_skola['broj'];
																			//PROVJERA DA LI JE CHEKIRANA SKOLA
																			// $check_skola = $db->prepare("
																			// 				SELECT * FROM idk_kandidat_edukacija 
																			// 				WHERE ke_kandidat_id = :ke_kandidat_id AND ke_prikaz_pp = 1
																			// ");
																			// $check_skola->execute(array(
																			// 				":ke_kandidat_id" => $kandidat_id
																			// ));
																			// $nr_skola = $check_skola->rowCount();
																			if($nr_skola > 0){
																			...
																			//PROVJERA DA LI JE CHEKIRANO ISKUSTVO
																			$row_work_exp = $check_work_experience->fetch();
																			$kri_prikaz_pp = $row_work_exp['kri_prikaz_pp'];
																			...
																			if($go_online_checker == 2){
																				if($logged_employee_id == 49 OR $logged_employee_id == 174 OR $logged_employee_id == 67 OR $logged_employee_id == 222  OR $logged_employee_id == 390 OR $logged_employee_id == 402 OR $logged_employee_id == 206 OR $logged_employee_id == 48 OR $logged_employee_id == 43 OR $logged_employee_id == 493){
																					$casting_column5 = '<a href="" data-toggle="modal" data-target="#modalGoOnline" data-kandidat_id="'.$kandidat_id.'" class="material-dropdown-menu__link idk_candidate_action_button idk_candidate_action_button_green goOnlineBtn" id="goOnlineBtn"><i class="fa fa-check" aria-hidden="true"></i></a>';
																					$sorting_column5 = '';
																				}else{
																					$casting_column5 = '';
																					$sorting_column5 = '';
																				...
																				$casting_column5 = '<span title="Potrebno je provjeriti školu i dodati termin!"><a href="#" style="pointer-events: none;" data-kandidat_id="'.$kandidat_id.'" class="material-dropdown-menu__link idk_candidate_action_button idk_candidate_action_button_red " ><i class="fa fa-minus" aria-hidden="true"></i></a></span>';
																				$sorting_column5 = '';
																			}

																			$casting_column6 = $njem_ispis;
																			
																		}else{
																			$casting_column1 = '<a href="'. getSiteUrlr() . $cv_filepath .'"><img src="'. getSiteUrlr() . $cv_flag_ba . '" width=25></a> <a href="'. getSiteUrlr() . $cv_filepath_de . '"><img src="' . getSiteUrlr() . $cv_flag_de . '" width=25></a>';
																			...
																			if($intervju_list){
																				...
																				//PROVJERA DA LI POSTOJI TERMIN
																				$check_termin = $db->prepare("
																								SELECT pap_date, pap_city, pca_time, pap_group_id 
																								FROM idk_pp_cand_appts 
																								JOIN idk_pp_appointments ON pca_appointment_id = pap_id 
																								WHERE pca_kandidat_id = :pca_kandidat_id AND pap_nalog_id = :pap_nalog_id and pca_status = 1
																				");
																				...
																				if($check_termin->rowCount() > 0){
																					...
																					$pap_date = $row_termin['pap_date'];
																					$pap_city = $row_termin['pap_city'];
																					$pap_group_id = $row_termin['pap_group_id'];
																					$asdfasasdf = $pap_city.' '.date('d.m.y H:i', strtotime($pap_date.' '.$pca_time));
																					$casting_column2 = $pap_city;
																					$casting_column3 = date('d.m.Y', strtotime($pap_date));
																					$casting_column4 = '<span class="label label-success material-label material-label_success material-label_xs main-container__column">'.date('H:i', strtotime($pca_time)).'</span>';
																					$sorting_column4 = ' data-order="'.date('H:i', strtotime($pca_time)).'" ';
																				}else{
																					$casting_column4 = '<span class="label label-danger material-label material-label_danger material-label_xs main-container__column">Nema</span>';
																					$sorting_column4 = '';
																				}
																				switch($tsr_status){
																					case 1:
																					...
																					default:
																						$status_dolaska = '
																							<a href="" data-toggle="modal" data-target="#modalDosao" data-kandidat_id="'.$kandidat_id.'" data-pap_group_id="'.$pap_group_id.'" class="material-dropdown-menu__link idk_candidate_action_button idk_candidate_action_button_green dosaoBtn" id="dosaoBtn"><i class="fa fa-check" aria-hidden="true"></i></a>
																							<a href="" data-toggle="modal" data-target="#modalNijeDosao" data-kandidat_id="'.$kandidat_id.'" data-pap_group_id="'.$pap_group_id.'" class="material-dropdown-menu__link idk_candidate_action_button idk_candidate_action_button_red nijeDosaoBtn" id="nijeDosaoBtn"><i class="fa fa-times" aria-hidden="true"></i></a>
																						';
																						$status_dolaska_sorting = ' data-order="Nepoznato"';
																				}
																				$casting_column6 = $status_dolaska;
																				
																			}elseif($odbijeni_list){
																				$count_string = strlen($kandidat_pp_razlog_odbijanja);
																				if($count_string > 30){
																					$razlog_short = substr($kandidat_pp_razlog_odbijanja, 0 ,30);
																					$casting_column4 = '<span class="label label-danger material-label material-label_danger material-label_xs main-container__column" title="'.$kandidat_pp_razlog_odbijanja.'">'.$razlog_short.'...</span>';
																					$sorting_column4 = '';
																				} else{
																					$casting_column4 = '<span class="label label-danger material-label material-label_danger material-label_xs main-container__column">'.$kandidat_pp_razlog_odbijanja.'</span>';
																					$sorting_column4 = '';
																				}
																				if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status))
																					$casting_column2 = $lg_url;
																				else
																					$casting_column2 = "";
																				$casting_column3 = $kandidat_prijava_na;
																				$casting_column6 = $kandidat_status;
																			}else{
																				if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){ 
																					$casting_column4 = '<span class="label label-success material-label material-label_success material-label_xs main-container__column">'.$kg_title.'</span>';
																					$sorting_column4 = '';
																				}else{
																					$casting_column4 = '';
																					$sorting_column4 = '';
																		...
																		if(!isset($_GET['search'])){ 
																			?>
																						<tr>
																							<td class="text-center"><input class="checkbox" type="checkbox" name="selectedrows[<?php echo $kandidat_id; ?>]" value="<?php echo $kandidat_id; ?>"></td>
																							...
																							<td class="text-center" <?php echo $sorting_column4; ?>><?php echo $casting_column4; ?></td>
																							...
																							<td class="text-center">
																								<div class="btn-group material-btn-group">
																									...
																									<ul class="dropdown-menu material-dropdown-menu material-dropdown-menu_primary idk_dropdown_table" role="menu">
																										...
																										<li><a href="#" class="material-dropdown-menu__link cvshow" data="<?php echo $getSiteUrl.$cv_filepath; ?>" data-id="<?php echo $getSiteUrl.$cv_filepath_de; ?>" data-toggle="modal" data-target="#cvModal"><i class="fa fa-folder-open-o" aria-hidden="true"></i> CV</a></li>
																										<?php }else{} ?>
																			...
																			if($_GET['kj_znanje_njemacki'] != "Svi"){ 
																				if($check_german > 0 AND $radno_iskustvo == "NE"){  
																					?>
																						<tr>
																							<td class="text-center"><input class="checkbox" type="checkbox" name="selectedrows[<?php echo $kandidat_id; ?>]" value="<?php echo $kandidat_id; ?>"></td>
																							<td class="text-center"><?php echo $kandidat_id; ?></td>
																					...
																					<?php 
																				}else if($check_german > 0 AND $radno_iskustvo == "DA") { 
																					if($check_work > 0){ 
																						?>
																						<tr>
																							<td class="text-center"><input class="checkbox" type="checkbox" name="selectedrows[<?php echo $kandidat_id; ?>]" value="<?php echo $kandidat_id; ?>"></td>
													...
													<script>
														...
														$(".dosaoBtn").click(function(){
															var kandidat_id = $(this).data("kandidat_id");
															var pap_group_id = $(this).data("pap_group_id");
															$("#kandidat_id_dosao").val(kandidat_id);
															$("#pap_group_id_dosao").val(pap_group_id);
															//$(this).css("pointer-events", "none");
														});
														$(".nijeDosaoBtn").click(function(){
															var kandidat_id = $(this).data("kandidat_id");
															var pap_group_id = $(this).data("pap_group_id");
															$("#kandidat_id_nije_dosao").val(kandidat_id);
															$("#pap_group_id_nije_dosao").val(pap_group_id);
															//$(this).css("pointer-events", "none");
														});
													...
													<!-- MODAL DOSAO NA INTERVJU -->
													<div class="modal material-modal material-modal_success fade" id="modalDosao">
														<div class="modal-dialog">
															<div class="modal-content material-modal__content">
																<div class="modal-header material-modal__header">
																	<button class="close material-modal__close" data-dismiss="modal">&times;</button>
																	<h4 class="modal-title material-modal__title">DOŠAO NA INTERVJU</h4>
																</div>
																<div class="modal-body material-modal__body">
																<form action="<?php getSiteURL(); ?>do?form=kandidat_dosao_na_intervju" method="POST">
																		<div class="form-group">
																			<div class="col-md-offset-2 col-sm-8">
																				Ovom akcijom potvrđujete da je kandidat DOŠAO na intervju.
																			</div>
																		</div>
																	</div>
																	<input type="hidden" name="kandidat_id_dosao" id="kandidat_id_dosao">
																	<input type="hidden" name="pap_group_id_dosao" id="pap_group_id_dosao">
																	<input type="hidden" name="nalog_id_dosao" id="nalog_id_dosao" value="<?php echo $project_nalogid; ?>">
																	<input type="hidden" name="project_id_dosao" id="project_id_dosao" value="<?php echo $project_id; ?>">
																	<div class="modal-footer material-modal__footer">
																		<button class="btn material-btn material-btn" data-dismiss="modal" id="zatvoriModal">Odustani</button>
																		<button type="submit" class="btn btn-primary material-btn material-btn_success val_isk_da">Potvrdi</button>
																	</div>
													...
													<!-- MODAL NIJE DOSAO NA INTERVJU -->
													<div class="modal material-modal material-modal_danger fade" id="modalNijeDosao">
														<div class="modal-dialog">
															<div class="modal-content material-modal__content">
																<div class="modal-header material-modal__header">
																	<button class="close material-modal__close" data-dismiss="modal">&times;</button>
																	<h4 class="modal-title material-modal__title">NIJE DOŠAO NA INTERVJU</h4>
																</div>
																<div class="modal-body material-modal__body">
																<form action="<?php getSiteURL(); ?>do?form=kandidat_nije_dosao_na_intervju" method="POST">
																		<div class="form-group">
																			<div class="col-md-offset-2 col-sm-8">
																				Ovom akcijom potvrđujete da kandidat <b>NIJE DOŠAO</b> na intervju.
																			</div>
																		</div>
																	</div>
																	<input type="hidden" name="kandidat_id_nije_dosao" id="kandidat_id_nije_dosao">
																	<input type="hidden" name="pap_group_id_nije_dosao" id="pap_group_id_nije_dosao">
																	<input type="hidden" name="nalog_id_nije_dosao" id="nalog_id_nije_dosao" value="<?php echo $project_nalogid; ?>">
																	<input type="hidden" name="project_id_nije_dosao" id="project_id_nije_dosao" value="<?php echo $project_id; ?>">
																	<div class="modal-footer material-modal__footer">
																		<button class="btn material-btn material-btn" data-dismiss="modal" id="zatvoriModal">Odustani</button>
																		<button type="submit" class="btn btn-primary material-btn material-btn_success val_isk_da">Potvrdi</button>
																	</div>
												...
												<div class="col-xs-12 col-sm-12 col-md-4">
													...
													<?php
														...
														$broj_na_provjeri = getEmployeesPerProjectsR($status_na_provjeri, $project_id);
														if($broj_na_provjeri > 0){
															$na_provjeri = "Na Provjeri(". $broj_na_provjeri . ")";
															$orange = "rgb(255, 159, 64)";
														}
														
														$broj_u_obradi = getEmployeesPerProjectsR($status_u_obradi, $project_id);
														if($broj_u_obradi > 0){
														...
														$broj_obradjen = getEmployeesPerProjectsR($status_obradjen, $project_id);
														if($broj_obradjen > 0){
															$obradjen = "Obrađen(". $broj_obradjen . ")";
															$green = "rgb(102, 213, 102)";
														}
														
														$broj_arhivirani = getEmployeesPerProjectsR($status_arhiviran, $project_id);
														...
														$broj_kontrola = getEmployeesPerProjectsR($status_kontrola, $project_id);
														if($broj_kontrola > 0){
															$kontrola = "Kontrola(". $broj_kontrola . ")";
															$light_blue = "rgb(148, 241, 252)";
														}
														
														$broj_dopuna = getEmployeesPerProjectsR($status_dopuna, $project_id);
														if($broj_dopuna > 0){
															$dopuna = "Dopuna(". $broj_dopuna . ")";
															$purple = "rgb(153, 102, 255)";
														}
														
														$broj_odbio_msngr = getEmployeesPerProjectsR($status_odbio_msngr, $project_id);
														if($broj_odbio_msngr > 0){
															$odbio_msngr = "Odbio Messenger(". $broj_odbio_msngr . ")";
															$orange2 = "rgb(255,68,11)";
														}
														
														$broj_u_obradi_3 = getEmployeesPerProjectsR($status_u_obradi_vise_od_3, $project_id);
														if($broj_u_obradi_3 > 0){
															$u_obradi_3 = "U obradi vise od 3 dana(". $broj_u_obradi_3 . ")";
															$yellow = "rgb(255, 205, 86)";
														}
														
														$broj_u_dopuni_3 = getEmployeesPerProjectsR($status_u_dopuni_vise_od_3, $project_id);
													...
													<script>
														...
														var config = {
															...
															data: {
																datasets: [{
																	data: [
																		<?php getEmployeesPerProjects($status_arhiviran, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_odbio_msngr, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_na_provjeri, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_u_obradi_vise_od_3, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_u_dopuni_vise_od_3, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_dopuna, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_u_obradi, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_kontrola, $project_id); ?>,
																		<?php getEmployeesPerProjects($status_obradjen, $project_id); ?>
																	],
																	backgroundColor: [
															...
															options: {
																...
																title: {
																	display: true,
																	text: 'Statistika kandidata za projekat <?php echo $project_name; ?>'
																},
																animation: {
																	animateScale: true,
																	animateRotate: true
				...
				case "del_doc":
					if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){
						...
						header("Location: " . getSiteURLr() . "projects?page=open&id=$document_dataid&mess=2");
				...
				case "del_note":
					if(in_array("1",$employee_status) OR in_array("2",$employee_status) OR in_array("3",$employee_status) OR in_array("4",$employee_status) OR in_array("7",$employee_status) OR in_array("9",$employee_status)){
						...
						header("Location: " . getSiteURLr() . "projects?page=open&id=$note_dataid&mess=4");
