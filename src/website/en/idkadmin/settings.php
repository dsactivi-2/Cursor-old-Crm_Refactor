							...
							<div class="col-sm-12">
								...
								<div id="myTabs" class="panel-group material-tabs-group">
		                            <ul class="nav nav-tabs material-tabs material-tabs_primary">
		                                <li class="active"><a href="#tab1" class="material-tabs__tab-link" data-toggle="tab">Engleski</a></li>
		                            </ul>
		                            <div class="tab-content materail-tabs-content">
		                                <div class="tab-pane fade active in" id="tab1">
											<?php
												...
												fclose($file);
											?>
											<form action="<?php getSiteURL(); ?>do?form=edit_lang_en" method="post">
												<textarea class="form-control" name="text_lang_en" rows="15" cols="80" required><?php echo $text; ?></textarea>
